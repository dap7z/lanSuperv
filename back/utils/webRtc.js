 ...
 * 
 * ⚠️ CODE SOURCE COMMUN AVEC LE FRONT : lanSuperv\front\src\js\utils\webRtc.js
 */
 ...
 */
function createPeerConnection(RTCPeerConnectionClass) {
 ...
 */
function setupPeerConnectionHandlers(pc, onIceCandidate, onIceConnectionStateChange, onConnectionStateChange) {
 ...
 */
async function applyPendingIceCandidates(pc, pendingCandidates, RTCIceCandidateClass, logPrefix = '[WebRTC Utils]') {
 ...
 */
async function addIceCandidate(pc, candidate, RTCIceCandidateClass, pendingCandidates, logPrefix = '[WebRTC Utils]') {
    if (!pc) {
 ...
 */
async function createAnswer(pc, offer, RTCSessionDescriptionClass) {
 ...
 */
function cleanupConnection(pc, dataChannel = null, connectionTimeout = null, pendingCandidates = null) {
